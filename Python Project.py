...
def sin(a,b):
    ...
    ans = math.sin(math.radians(a))+(0*b)
    return ans
def cos(a,b):
    ans= math.cos(math.radians(a))+(0*b)
    return ans
def tan(a,b):
    ans= math.tan(math.radians(a))+(0*b)
    return ans
...
operations={'ADD':add,'ADDITION':add,'SUM':add,'PLUS':add,
            ...
            'LCM':lcm , 'HCF':hcf,
            'MOD':mod ,'REMAINDER':mod , 'MODULUS':mod ,'SIN':sin,'COS':cos,'TAN':tan }
